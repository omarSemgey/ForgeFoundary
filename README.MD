...
For detailed instructions, examples, and a map of available documentation, refer to the [Docs/manual](https://omarsemgey.github.io/ForgeFoundary/). it provides an organized overview of all other documentation files included with ForgeFoundary.
