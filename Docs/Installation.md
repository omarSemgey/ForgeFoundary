...
>When running via Docker, post-process hooks that require host-machine binaries (like npm or local composer) are not supported unless they are available within the container
